truncate table AST_AR_ANL_FCT_FULL_DAILY_RERUN;

insert into AST_AR_ANL_FCT_FULL_DAILY_RERUN
select * from admin.AST_AR_ANL_FCT_FULL 
where TM_PRD_DIM_ID in (select distinct TM_PRD_DIM_ID from TMP_AR_ANL_FCT_MNUL_DAILY);

delete from admin.AST_AR_ANL_FCT_FULL where TM_PRD_DIM_ID in (select distinct TM_PRD_DIM_ID from TMP_AR_ANL_FCT_MNUL_DAILY);

insert into AST_AR_ANL_FCT_FULL
SELECT AR_ID
       , t.CR_RSK_RTG_DIM_ID
       ...
       , nvl(tmp.MNUL_ADJ_FTP_AMT_MTD_LCY,0) AGRT_MNUL_ADJ_AST_NIM_MTD 
       , nvl(tmp.MNUL_ADJ_FTP_AMT_QTD_LCY,0) AGRT_MNUL_ADJ_AST_NIM_QTD
       , nvl(tmp.MNUL_ADJ_FTP_AMT_YTD_LCY,0) AGRT_MNUL_ADJ_AST_NIM_YTD
       , t.LMT_AMT_FCY
       , t.LMT_AMT_LCY
  ...
  FROM DMMIS.ADMIN.AST_AR_ANL_FCT_FULL_DAILY_RERUN t
