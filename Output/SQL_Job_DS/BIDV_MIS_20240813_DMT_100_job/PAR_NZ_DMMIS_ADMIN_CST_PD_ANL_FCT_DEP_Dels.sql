...
\(9)\(9), NVL(TWT.SLRY_CR_TXN_IND, 'N')       SLRY_CR_TXN_IND
...
\(9)INNER JOIN SRC_STM_DIM ON SRC_STM_DIM.SRC_STM_DIM_ID = F.SRC_STM_DIM_ID AND SRC_STM_DIM.LVL_0_CODE IN ('SIBS_CDMAST', 'SIBS_DDMAST', 'TTSPKB')
