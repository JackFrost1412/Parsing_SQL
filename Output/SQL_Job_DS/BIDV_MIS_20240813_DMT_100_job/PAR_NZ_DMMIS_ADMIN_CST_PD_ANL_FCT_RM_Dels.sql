SELECT 
       ...
       , TWT.CST_PD_ST_CODE		CST_PD_ST_CODE
	...
	, NVL(TWT.TOT_NBR_OF_CST_TXN_TDY, 0)						TOT_NBR_OF_CST_TXN_TDY
       ...
       , twt.TOT_NBR_OF_PASSIVE_TXN_DB_TDY		TOT_NBR_OF_PASSIVE_TXN_DB_TDY	
		, CASE WHEN TWT.CLS_PD_IND = 1 THEN 'Y' ELSE 'N' END		CLS_PD_IND
...
LEFT JOIN 		CST_PD_ST_DIM ON CST_PD_ST_DIM.LVL_0_CODE = TWT.CST_PD_ST_CODE AND TO_DATE(SYS.PARAM_VALUE,'YYYYDDD') >= CST_PD_ST_DIM.EFF_FM_DT AND CST_PD_ST_DIM.EFF_TO_DT >  TO_DATE(SYS.PARAM_VALUE,'YYYYDDD')
