...
FROM TMP_AR_ANL_FCT_SGD3_ODA_NHANNGUONUT TWT 
...
WHERE AR_DIM.SRC_STM = 'SGD3_ODA_NHANNGUONUT' AND TO_DATE(SYS.PARAM_VALUE,'YYYYDDD') >= AR_DIM.EFF_FM_DT AND AR_DIM.EFF_TO_DT >  TO_DATE(SYS.PARAM_VALUE,'YYYYDDD')
;
