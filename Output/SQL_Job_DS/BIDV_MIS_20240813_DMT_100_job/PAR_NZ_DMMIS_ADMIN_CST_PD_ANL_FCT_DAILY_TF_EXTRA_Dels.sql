...
\(9)   , NVL(SLRY_TVR_SEG_DIM.SLRY_TVR_SEG_DIM_ID, 999999)\(9)\(9)\(9)SLRY_TVR_DIM_ID
       ...
       , NVL(OCP_DIM.OCP_DIM_ID, '999999')\(9)\(9)\(9)\(9)OCP_DIM_ID
       , NVL(MAR_ST_DIM.MAR_ST_DIM_ID, '999999')\(9)\(9)MAR_ST_DIM_ID
       , 999999\(9)\(9)\(9)\(9)\(9)CST_HIER_DIM_ID
       , NVL(CST_LCS_DIM.CST_LIFE_CYC_ST_DIM_ID, '999999')\(9)\(9)\(9)CST_LCS_TP_DIM_ID
...
\(9)   , NVL(NVL(CST_RLTNP_AGE_SEG.RLTNP_AGE_SEG_DIM_ID,MAX_RLTNP_AGE.RLTNP_AGE_SEG_DIM_ID) , 999999)\(9)\(9)CST_AGE_SEG_DIM_ID
       ...
       , NVL(CR_RSK_RTG_DIM.CR_RSK_RTG_DIM_ID, '999999')\(9)\(9)\(9)CR_RSK_RTG_DIM_ID
       , NVL(CR_LMT_BAL_SEG.CR_LMT_SEG_DIM_ID, 999999)\(9)\(9)\(9)\(9)CR_LMT_SEG_DIM_ID
       , NVL(IDY_CL_DIM.IDY_SML_ID_DIM_ID, '999999')\(9)\(9)\(9)\(9)IDY_SML_ID_DIM_ID
       ...
       , NVL(PERF_ST_DIM.PERF_ST_DIM_ID, '999999')\(9)\(9)\(9)\(9)\(9)CST_PERF_ST_DIM_ID
       , NVL(CST_RLTNP_OFCR.EMPE_DIM_ID,999999 )\(9)\(9)\(9)\(9)\(9)CST_RLTNP_OFCR_DIM_ID
...
\(9)\(9), CASE WHEN TWT_TDY.CLS_PD_IND = 1 THEN 'Y' ELSE 'N' END\(9)\(9)CLS_PD_IND\(9) 
...
\(9)
\(9)\(9), CASE WHEN TWT.TOT_NBR_OF_CST_TXN_TDY > 0 THEN\(9) TO_NUMBER(CDR_DT_DIM.CDR_DT_DIM_ID, 9999999)  ELSE PRE.LAST_CST_TXN_DT_DIM_ID END LAST_CST_TXN_DT_DIM_ID\(9)\(9)\(9)\(9), NVL(TWT.TOT_AST_ACR_INT_AMT_TDY_LCY, 0)\(9)\(9)\(9)TOT_AST_ACR_INT_AMT_TDY_LCY
...
\(9)\(9), NVL(TMP_CST_SEG.CST_SEG_DIM_ID, 999999)\(9)\(9)\(9)CST_SEG_DIM_ID\(9)   
...
FROM TWT_CST_PD_ANL_TF_EXTRA  TWT
LEFT JOIN (
\(9)SELECT DISTINCT T.CST_ID,  T.PD_ID, T.SRC_STM_ID, T.CST_PD_ST_CODE, CLS_PD_IND
\(9)FROM TWT_CST_PD_ANL_TF T
\(9)union 
\(9)SELECT DISTINCT T.CST_ID,  T.PD_ID, T.SRC_STM_ID, T.CST_PD_ST_CODE, CLS_PD_IND
\(9)FROM TWT_CST_PD_ANL_BG T
...
\(9)\(9)\(9)\(9)CASE WHEN (PD_DIM.PD_CODE LIKE 'TFLC%' OR  PD_DIM.PD_CODE LIKE 'TFUB%')\(9)THEN (
\(9)\(9)\(9)\(9)\(9)CASE \(9)WHEN NVL(TWT.TOT_AST_CLS_BAL_AMT_TDY_LCY, 0) <> 0  OR NVL(TWT.LAST_CST_TXN_DT_DIM_ID, FCT_PRE.LAST_CST_TXN_DT_DIM_ID) >= TO_NUMBER(TO_CHAR(add_months(TO_DATE(SYS.PARAM_VALUE, 'YYYYDDD'), -6), 'YYYYDDD'), 9999999) THEN 'USING'
\(9)\(9)\(9)\(9)\(9)\(9)\(9)ELSE 'DORMANT'
\(9)\(9)\(9)\(9)\(9)END)
\(9)\(9)\(9)\(9)ELSE (
\(9)\(9)\(9)\(9)\(9)CASE \(9)WHEN NVL(TWT.LAST_CST_TXN_DT_DIM_ID, FCT_PRE.LAST_CST_TXN_DT_DIM_ID) >= TO_NUMBER(TO_CHAR(add_months(TO_DATE(SYS.PARAM_VALUE, 'YYYYDDD'), -6), 'YYYYDDD'), 9999999) THEN 'USING'
\(9)\(9)\(9)\(9)\(9)\(9)\(9)\(9)\(9)WHEN NVL(TWT.LAST_CST_TXN_DT_DIM_ID, FCT_PRE.LAST_CST_TXN_DT_DIM_ID) IS NULL THEN 'NOT_USE'
\(9)\(9)\(9)\(9)\(9)\(9)\(9)\(9)\(9)ELSE 'DORMANT'
\(9)\(9)\(9)\(9)\(9)END)
\(9)\(9)\(9)\(9)END )
\(9)\(9)\(9)ELSE 'UNKNOWN'
...
\(9)\(9)FROM TWT_CST_PD_ANL_TF TWT
...
\(9)INNER JOIN SRC_STM_DIM ON SRC_STM_DIM.SRC_STM_DIM_ID = F.SRC_STM_DIM_ID AND SRC_STM_DIM.LVL_0_CODE IN ('SIBS_TFMAST')
