truncate table AST_AR_ANL_FCT_FULL_DAILY;

INSERT INTO AST_AR_ANL_FCT_FULL_DAILY
SELECT
		T.AR_ID,
		T.CR_RSK_RTG_DIM_ID,
...
delete from AST_AR_ANL_FCT_FULL where tm_prd_dim_id = (select param_value from cstb_system where param_name = 'ETL_DATE');

insert into AST_AR_ANL_FCT_FULL select * from AST_AR_ANL_FCT_FULL_DAILY;
