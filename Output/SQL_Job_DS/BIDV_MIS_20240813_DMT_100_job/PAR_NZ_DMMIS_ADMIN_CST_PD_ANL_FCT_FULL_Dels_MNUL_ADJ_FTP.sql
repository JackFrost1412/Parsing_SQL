truncate table CST_PD_ANL_FCT_FULL_DAILY_RERUN;

insert into CST_PD_ANL_FCT_FULL_DAILY_RERUN
select * from admin.CST_PD_ANL_FCT_FULL 
where TM_PRD_DIM_ID in (select distinct TM_PRD_DIM_ID from TMP_CST_PD_ANL_FCT_MNUL_DAILY);

delete from admin.CST_PD_ANL_FCT_FULL where TM_PRD_DIM_ID in (select distinct TM_PRD_DIM_ID from TMP_CST_PD_ANL_FCT_MNUL_DAILY);

insert into CST_PD_ANL_FCT_FULL
SELECT t.CST_ID
       , t.PD_ID
       , t.ORG_UNIT_ID
       , t.PD_TP
  ...
  FROM DMMIS.ADMIN.CST_PD_ANL_FCT_FULL_DAILY_RERUN t
