SELECT   AR_DIM.AR_ID 	AR_ID,
       ...
       , NVL(TWT.CLS_BAL_FRST_DAY_OVERDAFT_BSN_FCY, 0) 	CLS_BAL_FRST_DAY_OVERDAFT_BSN_FCY
       , NVL(TWT.CLS_BAL_FRST_DAY_OVERDAFT_BSN_LCY, 0)	CLS_BAL_FRST_DAY_OVERDAFT_BSN_LCY
       , NVL(TWT.TOT_CNTS_OD_DB_BSN_AMT_FCY, 0)			TOT_CNTS_OD_DB_BSN_AMT_FCY
       , NVL(TWT.TOT_CNTS_OD_DB_BSN_AMT_LCY, 0)			TOT_CNTS_OD_DB_BSN_AMT_LCY
...
FROM TMP_AR_ANL_FCT_ODTIER TWT 
...
WHERE AR_DIM.SRC_STM = 'SIBS_ODTIER' AND TO_DATE(SYS.PARAM_VALUE,'YYYYDDD') >= AR_DIM.EFF_FM_DT AND AR_DIM.EFF_TO_DT >  TO_DATE(SYS.PARAM_VALUE,'YYYYDDD')
;
