SELECT   AR_DIM.AR_ID 	AR_ID,
       ...
       , NVL(TWT.AR_PPS_ID, 999999)			AR_PPS_DIM_ID
       ...
       , NVL(TWT.BAL_SHET_TP_ID, '999999')	BAL_SHET_TP_DIM_ID
       ...
       , NVL(TWT.LAST_INT_PYMT_DT_ID, '999999')  		LAST_INT_PYMT_DT_DIM_ID
       , TWT.LAST_PNP_PYMT_AMT_FCY
       , TWT.LAST_PNP_PYMT_AMT_LCY
       , NVL(TWT.LAST_PNP_PYMT_DT_ID, '999999')  		LAST_PNP_PYMT_DT_DIM_ID
       ...
       , NVL(TWT.NXT_INT_PYMT_DT_ID, '999999')   NXT_INT_PYMT_DT_DIM_ID
       , TWT.NXT_PNP_PYMT_AMT_FCY
       , TWT.NXT_PNP_PYMT_AMT_LCY
       , NVL(TWT.NXT_PNP_PYMT_DT_ID, '999999')  NXT_PNP_PYMT_DT_DIM_ID
       ...
       , NVL(TWT.SCR_CVR_ID, '999999')	SCR_CVR_DIM_ID
       ...
       , NVL(CR_FCY_AR_DIM.TOT_LMT_AMT_FCY, 0)		TOT_LMT_AMT_FCY
       , NVL(CR_FCY_AR_DIM.TOT_LMT_AMT_LCY, 0)		TOT_LMT_AMT_LCY
...
, NVL(TWT.LBY_ACR_INT_TDY_LCY, 0)			LBY_ACR_INT_TDY_LCY
       , NVL(CR_FCY_AR_DIM.TOT_LMT_AMT_FCY, 0)		LMT_AMT_FCY
       , NVL(CR_FCY_AR_DIM.TOT_LMT_AMT_LCY, 0)		LMT_AMT_LCY
		...
		, 0	AST_NML_INT_INCM_HTD_FCY
		, 0	AST_NML_INT_INCM_HTD_LCY
...
WHERE AR_DIM.SRC_STM = 'SIBS_CDMAST' AND TO_DATE(SYS.PARAM_VALUE,'YYYYDDD') >= AR_DIM.EFF_FM_DT AND AR_DIM.EFF_TO_DT >  TO_DATE(SYS.PARAM_VALUE,'YYYYDDD')
;
