...
DELETE FROM CARD_TXN_ANL_FCT WHERE CDR_DIM_ID = :pDate:;

DELETE FROM CARD_TXN_ANL_FCT f WHERE EXISTS(select 1 from CARD_TXN_ANL_FCT_DAILY d where d.TXN_ID = f.TXN_ID);

INSERT INTO CARD_TXN_ANL_FCT (CST_DIM_ID
       , PD_DIM_ID
       ...
       , CNL_DIM_ID
       , MRCH_DIM_ID
       , CARD_TP_ACQUIRER_DIM_ID
       , TXN_NTW_DIM_ID
       , TXN_CODE_DIM_ID
       , MRCH_OFCR_EMPE_DIM_ID
       , MRCH_MGT_DEPT_DIM_ID
       , CTY_OF_TXN_DIM_ID
       , TXN_LC_ST_DIM_ID
       , PRIM_AR_MGT_DEP_DIM_ID
       , CNT_IND
       , TXN_TCKT_NBR
       , CR_X_DB_IND
       , TXN_AMT_IND
       ...
       , MRCH_RATE_PCT
       , TXN_REMARK
	   , CNL_MGT_DEP_DIM_ID			   , CNL_OFCR_EMPE_DIM_ID		   , AHR_CODE					   , MRCH_CGY_DIM_ID			   , SRC_STM_DIM_ID				   , ORIG_CCY_DIM_ID			   , TXN_ID						   , MRCH_ORG_UNIT_DIM_ID		   , TXN_LCL_DT_DIM_ID			   , TXN_PRCH_DT_DIM_ID		)
SELECT CST_DIM_ID
       , PD_DIM_ID
       , PRIM_ORG_DIM_UNIT_ID
       , CDR_DIM_ID
       ...
       , MRCH_RATE_PCT
       , TXN_REMARK
	   , CNL_MGT_DEP_DIM_ID			   , CNL_OFCR_EMPE_DIM_ID		   , AHR_CODE					   , MRCH_CGY_DIM_ID			   , SRC_STM_DIM_ID				   , ORIG_CCY_DIM_ID			   , TXN_ID						   , MRCH_ORG_UNIT_DIM_ID		   , TXN_LCL_DT_DIM_ID			   , TXN_PRCH_DT_DIM_ID		  FROM CARD_TXN_ANL_FCT_DAILY;
