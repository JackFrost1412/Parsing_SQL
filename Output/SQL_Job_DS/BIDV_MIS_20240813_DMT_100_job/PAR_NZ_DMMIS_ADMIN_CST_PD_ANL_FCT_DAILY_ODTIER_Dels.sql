...
FROM TWT_CST_PD_ANL_ODTIER  TWT
...
\(9)INNER JOIN SRC_STM_DIM ON SRC_STM_DIM.SRC_STM_DIM_ID = F.SRC_STM_DIM_ID AND SRC_STM_DIM.LVL_0_CODE IN ('SIBS_ODTIER')
\(9)
