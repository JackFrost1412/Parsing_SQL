...
sql_file_path = r'SourceCode\Parsing_SQL\Input_SQL_command\sub-select.sql'
sql_content = read_sql_file(sql_file_path)

inner_join_df_subselects = Extract_Subselects.process_sql_with_source(sql_content)
